...
class yapita extends StatefulWidget {
  const yapita({Key? key}) : super(key: key);

  @override
  State<yapita> createState() => _yapitaState();
}

class _yapitaState extends State<yapita> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Image.asset('lib/assets/BRGR.png', fit: BoxFit.contain,height: 40,width: 60,),
        centerTitle: true,
      ),
      body: Container(
        ...
        child: ListView(
          children:<Widget> [
            Card(
              ...
              child: Center(child: Text('Pain Piata Grec',style: TextStyle(fontSize: 40,color: Colors.lightGreenAccent),)),
              elevation: 0,
            ),
            Card(
              child: ListTile(
